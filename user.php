...
<script> if(typeof window.history.pushState == 'function') { window.history.pushState({}, "Hide", "user.php"); } </script>
<style>
body{
...
<div class="logo">
 ...
 <input type="hidden" name="item_id" value="<?php echo $row['Product_id'] ?>">
  ...
  <input type="hidden" name="item_price" value="<?php echo $row['Price'] ?>">
    <input type="hidden" name="item_category" value="<?php echo $row['Category_Name'] ?>">
